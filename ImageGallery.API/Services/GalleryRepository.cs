...
namespace ImageGallery.API.Services
{
    public class GalleryRepository : IGalleryRepository, IDisposable
    {
        ...
        public void DeleteImage(Image image)
        {
            ...
            // Note: in a real-life scenario, the image itself should also be removed
            // from the disk. We don't do this in this demo scenario,
            // aswe refill the DB with image URIs (that require the actual files as well)
            // for demo purpose
        }
